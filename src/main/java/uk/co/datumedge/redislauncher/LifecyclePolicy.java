...
public interface LifecyclePolicy {
	 ...
	 * is useful
	 * for destroying a redis server process when the JVM terminates, for example. An implementation should return
	 * {@link NullProcessDestroyer#INSTANCE} if no special behaviour is needed.
	 * 
